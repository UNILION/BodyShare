...
import SearchList from "pages/community/commu/commuSearch/SearchList";
import { useRecoilState, useRecoilValue } from 'recoil';
import { sportsSelector } from "recoil/sportList";
import Selected from "pages/community/commu/commuSearch/Selected";
import { searchAtom } from "recoil/commuRecoil";
...
const Middle = function ({searchItemList}) {
  ...
  // 선택된 항목 리스트
  const [selectedList, setSelectedList] = useState(searchItemList);
  ...
  const complete = function() {
    setSearchItem(selectedList);
    navigate("/community/challenge/challSearchAfter")
  };
